...
import WitdrawCryptoConfirmPopup from './index';

// ================================================:
describe('Witdraw crypto confirm popup component:', () => {
	it('Witdraw crypto confirm popup component must be render', () => {
		...
		const testCurrentWalletNetwork = {
			network_id: 'default',
			network_name: 'btc',
			withdrawable: 1,
			depositable: 1,
			...
			<ReduxProvider store={store}>
				<BrowserRouter>
					<WitdrawCryptoConfirmPopup
						...
						recieveAmount={10}
						amount={30}
						currentWallet={testCurrentWallet}
						currentWalletNetwork={testCurrentWalletNetwork}
					/>
				</BrowserRouter>
			</ReduxProvider>,
		);
