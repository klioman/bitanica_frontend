webpackJsonp([1], {
			...
			(n.prototype.updateImpl = function () {
				...
				r.prototype._updateImpl.call(this),
					...
					this._source.points().length >= 5 &&
						...
						(this._CDRetracement =
							Math.round(1e3 * Math.abs((s.price - n.price) / (n.price - i.price))) / 1e3),
						(this._XDRetracement =
							Math.round(1e3 * Math.abs((s.price - t.price) / (t.price - e.price))) / 1e3));
			}),
					...
					for (l = this._source.levelsCount(), h = 1; h <= l; h++)
						(d = 'level' + h),
							...
							c.visible.value() &&
								...
								(u = s + p * r),
								this._source.priceScale().isPercent() &&
									(u = this._source.priceScale().priceRange().convertToPercent(u, o)),
						...
						? ((e = this._source.priceScale()),
						  ...
						  (g = {
								...
								6: function (e, t) {
									return new r(
										u + t * f,
										l((e[TradingView.HIGH_PLOT] + e[TradingView.LOW_PLOT]) / 2) + _.y,
									);
								},
						  }),
					...
					for (this._levels = [], r = t ? t.index - e.index : 1, a = 1; a <= 11; a++)
						(o = i['level' + a]),
							o.visible.value() &&
								...
								i.showLabels.value() &&
									((d.text = o.coeff.value()), (d.y = this._source.priceScale().height())),
								this._levels.push(d));
			}),
			(n.prototype.renderer = function () {
					...
					this._points.length < 2 || this._source.points().length < 2
						...
						: ((t = this._source.properties()),
						  ...
						  L &&
								...
								((this._pipFormatter = new p(L.pricescale, L.minmov, L.type, L.minmove2)),
					...
					this._labelDataInvalidated &&
						...
						R &&
							...
							T instanceof r &&
								...
								((k = L.subtract(T)),
								k.length() > 0 &&
									((k = k.normalized()), (C = Math.acos(k.x)), k.y > 0 && (C = -C))),
							'number' != typeof C ||
								TradingView.isNaN(C) ||
					...
					for (
						...
						(h = 'hlevel' + l),
							...
							d.visible.value() &&
								...
								(_ = a + c * r),
								this._source.priceScale().isPercent() &&
									(_ = this._source.priceScale().priceRange().convertToPercent(_, o)),
					...
					for (
						...
						(a = 'hlevel' + r),
							...
							o.visible.value() &&
								...
								(d = e.price + l * i),
								this._source.priceScale().isPercent() &&
									(d = this._source.priceScale().priceRange().convertToPercent(d, n)),
				...
				return (
					...
					(t.prototype._updateImpl = function () {
						...
						e.prototype._updateImpl.call(this),
							...
							i.length < 2 ||
								n.length < 2 ||
								((r = n[0]), (s = n[1]), (i[1] = r), (i[1].data = 1), (i[2] = s));
					}),
					(t.prototype._initRenderers = function () {
						var e,
							t,
				...
				r.prototype._updateImpl.call(this),
					...
					this._source.points().length < 2 ||
						(this._source.priceScale() &&
							((e = this._source.points()[0]),
							(t = this._source.points()[1]),
							(this._price1 = this._source.priceScale().formatter().format(e.price)),
							(this._price2 = this._source.priceScale().formatter().format(t.price)),
							3 === this._source.points().length &&
								((i = this._source.points()[2]),
								(this._price3 = this._source.priceScale().formatter().format(i.price)),
								(n = t.price - e.price),
		...
		inherit(n, a),
			...
			(n.prototype.updateImpl = function () {
				a.prototype._updateImpl.call(this),
					(this._distance = 0),
					3 === this._points.length &&
						(this._distance = s(this._points[0], this._points[1], this._points[2]).distance);
			}),
			(n.prototype.renderer = function () {
	...
	1165: function (e, t, i) {
		...
		(n.prototype.setData = function (e) {
			...
			(n.prototype._continiusFib = function (e) {
				...
				return s >= n.length
					? null
					: ((t = e - r), (t = Math.pow(t, 1.15)), (i = n[s] - n[r]), n[r] + i * t);
			}),
			(n.prototype.hitTest = function (e) {
				...
				s.prototype._updateImpl.call(this),
					...
					this._points.length >= 5 &&
						...
						7 === this._points.length &&
							...
							(h = this._points[6]),
							null !== (a = r(i, n, l, h)) &&
								((o = n.subtract(i)), (this._intersect2 = i.add(o.scaled(a))))));
			}),
			...
			(n.prototype.updateImpl = function () {
				...
				r.prototype._updateImpl.call(this),
					...
					this._source.points().length >= 6 &&
						...
						(this._retrace2 =
							Math.round(100 * Math.abs((s.price - n.price) / (n.price - i.price))) / 100));
			}),
					...
					this._points.length < 2 || this._source.points().length < 2
						...
						: ((t = this),
						  ...
						  N &&
								...
								((this._pipFormatter = new _(N.pricescale, N.minmov, N.type, N.minmove2)),
				...
				h.prototype._updateImpl.call(this),
					...
					this._source.points().length < 2 ||
						(this._source.priceScale() &&
							((e = this._source.points()[1]),
							(t = this._source.points()[0]),
							(this._targetLine3 = this._source.priceScale().formatter().format(e.price)),
							(i = e.price - t.price),
							(n = i < 0 ? '-' : '+'),
							(this._targetLine1 = this._source.priceScale().formatter().format(Math.abs(i))),
							(r = Math.abs(Math.round((i / t.price) * 1e4) / 100)),
							(this._targetLine1 =
								n + this._targetLine1 + ' (' + n + this._percentageFormatter.format(r) + ')'),
							...
							a &&
								...
								l ||
									(this._targetLine4 =
										this._targetLine4 + '  ' + new v(c ? '%h:%m:%s' : '%h:%m').format(a)),
								(p = (a.valueOf() - s.valueOf()) / 1e3),
								(this._targetLine2 = $.t('in', { context: 'dates' }) + ' ' + new w().format(p))),
							(this._sourceLine1 = this._source.priceScale().formatter().format(t.price)),
							(this._sourceLine2 = ''),
							...
							_ &&
								...
								l ||
									(this._sourceLine2 =
										this._sourceLine2 + ' ' + new v(c ? '%h:%m:%s' : '%h:%m').format(_))),
				...
				return null === this._data || null === this._points || 0 === this._points.length
					...
					: ((t = this._points[0].x - this._measureCache.tailLeft),
					  ...
					  a(
							e,
							new s(t, i),
							new s(t + this._measureCache.innerWidth, i + this._measureCache.innerHeight),
					  )
							? new h(h.MOVEPOINT)
							: null);
			}),
	...
	1175: function (e, t, i) {
		...
		(n.prototype.update = function (e) {
			...
			(n.prototype.drawOn = function (e) {
				var t = new a(Math.round(this._data.point.x), Math.round(this._data.point.y)).add(
					this._translate,
				);
			...
			(r.prototype.drawTooltipOn = function (e) {
				...
				for (
					e.save(),
						...
						c ||
							'bottom' !== p ||
							(e.lineTo(u + 7, d + o), e.lineTo(u, d + o + 7), e.lineTo(u - 7, d + o)),
						e.lineTo(l, d + o),
						e.closePath(),
						e.fill(),
						e.stroke(),
							...
							: ((e = this._source.properties()),
							  ...
							  this.isAnchorsRequired()
									? ((n = new l()),
									  ...
									  t.wordWrapWidth &&
											((o = new s(
												r.x + (t.wordWrapWidth >> 1) + d.RoundRadius + d.TextMargins,
												r.y,
											)),
											(o.data = 1),
		...
		(n.prototype.setData = function (e) {
			...
			(n.prototype.draw = function (e) {
				...
				null !== this._data &&
					...
					this._measureCache &&
						$.extend(this._measureCache, { innerWidth: r, innerHeight: s, padding: n }),
				...
				r.prototype._updateImpl.call(this),
					...
					this._source.points().length >= 5 &&
						...
						(this._CDRetracement =
							Math.round(1e3 * Math.abs((s.price - n.price) / (n.price - i.price))) / 1e3),
						(this._XDRetracement =
							Math.round(1e3 * Math.abs((s.price - n.price) / (e.price - n.price))) / 1e3));
			}),
			(t.CypherPaneView = n);
	},
	1190: function (e, t, i) {
				...
				return (
					...
					(e.prototype.draw = function (e) {
						...
						if (null !== this._data && null !== (t = this._visiblePolygon())) {
							...
							(e.fillStyle = d.generateColor(this._data.color, this._data.transparency, !0)),
								e.fill();
						}
					}),
				...
				return (
					...
					(e.prototype.draw = function (e) {
						...
						null === this._data ||
							...
							e.lineTo(i.x, i.y),
							this._data.fillBackground &&
								((e.fillStyle = a.generateColor(this._data.backcolor, this._data.transparency)),
								e.fill()),
							e.stroke());
					}),
					(e.prototype.hitTest = function (e) {
	...
	1240: function (e, t, i) {
		...
		function s(e, t, i) {
			return null !== e
				? c.intersectPolygonAndHalfplane(e, l.halfplaneThroughPoint(r(t), new l.Point(i, 0)))
				: null;
		}
		function a(e, t) {
			var i = t.points,
				...
				return (
					...
					(e.prototype._visiblePolygons = function () {
						...
						return _.width <= 0 || _.height <= 0
							? []
							: null ===
							  (e = c.intersectLines(l.lineThroughPoints(f, g), l.lineThroughPoints(v, w)))
							? []
							: ((t = [
									new l.Point(0, 0),
				...
				if (
					...
					for (a = this._source.points(), o = 1; o < a.length; o++)
						(l = a[o - 1]),
							...
							(u = h.price),
							this._source.priceScale().isPercent() &&
								((_ = this._source.priceScale().priceRange().convertToPercent(_, n)),
								(u = this._source.priceScale().priceRange().convertToPercent(u, n))),
