				...
				if ('string' == typeof (n = e.getAttribute(r))) {
					try {
						n =
							'true' === n ||
							('false' !== n &&
								('null' === n ? null : xt.isNumeric(n) ? +n : L.test(n) ? xt.parseJSON(n) : n));
					} catch (e) {}
					xt.data(e, t, n);
				} else n = void 0;
			}
		...
		(xt.Callbacks = function (e) {
				...
				return (
					...
					xt(function () {
						...
						g &&
							...
							t.appendChild(f),
							(f.innerHTML =
								"<table><tr><td style='" + m + "0;display:none'></td><td>t</td></tr></table>"),
					...
					if (xt.acceptData(e)) {
						...
						if ((f && c[f] && (d || r || c[f].data)) || !u || void 0 !== n)
							return (
								...
								d && !i[t]
									? o.events
									: (u ? null == (a = i[t]) && (a = i[xt.camelCase(t)]) : (a = i), a)
							);
					}
				},
					...
					if (xt.acceptData(e)) {
						...
						if (l[c]) {
							if (t && (r = n ? l[c] : l[c].data)) {
								xt.isArray(t) ||
									(t in r ? (t = [t]) : ((t = xt.camelCase(t)), (t = t in r ? [t] : t.split(' '))));
			...
			xt.fn.extend({
				data: function (e, t) {
					...
					if (void 0 === e) {
						if (
							this.length &&
							((c = xt.data(u)), 1 === u.nodeType && !xt._data(u, 'parsedAttrs'))
						) {
							for (i = u.attributes, s = i.length; l < s; l++)
								(a = i[l].name),
									0 === a.indexOf('data-') && ((a = xt.camelCase(a.substring(5))), r(u, a, c[a]));
					...
					if ((e && 'string' == typeof e) || void 0 === e)
						for (t = (e || '').split(F), n = 0, r = this.length; n < r; n++)
							if (((o = this[n]), 1 === o.nodeType && o.className))
								if (e) {
									for (
										i = (' ' + o.className + ' ').replace(A, ' '), a = 0, s = t.length;
										a < s;
										a++
									)
										i = i.replace(' ' + t[a] + ' ', ' ');
						...
						: this.each(function () {
								if ('string' === n)
									...
									('undefined' !== n && 'boolean' !== n) ||
										...
										(this.className =
											this.className || !1 === e ? '' : xt._data(this, '__className__') || ''));
						  });
				},
				hasClass: function (e) {
				...
				(z = xt.valHooks.button =
					{
						get: function (e, t) {
							...
							return (
								...
								n && (V[t] ? '' !== n.nodeValue : n.specified) ? n.nodeValue : void 0
							);
						},
						set: function (e, t, n) {
					...
					if (y && (d = y.events)) {
						for (t = xt.trim(te(t || '')).split(' '), i = 0; i < t.length; i++)
							if (((a = $.exec(t[i]) || []), (s = u = a[1]), (l = a[2]), s)) {
								...
								0 === m.length &&
									c !== m.length &&
									((p.teardown && !1 !== p.teardown.call(e, l)) || xt.removeEvent(e, s, y.handle),
									delete d[s]);
							} else for (s in d) xt.event.remove(e, s + t[i], n, r, !0);
						xt.isEmptyObject(d) &&
							((h = y.handle), h && (h.elem = null), xt.removeData(e, ['events', 'handle'], !0));
					}
				},
							...
							if (
								...
								if (
									...
									if (((d = [[n, c.bindType || h]]), !r && !c.noBubble && !xt.isWindow(n))) {
										for (
											p = c.delegateType || h, s = X.test(p + h) ? n : n.parentNode, u = null;
											s;
											s = s.parentNode
										)
											d.push([s, p]), (u = s);
							...
							for (
								...
								(l = s.matches[n]),
									(h ||
										...
										(e.handleObj = l),
										void 0 !==
											(i = ((xt.event.special[l.origType] || {}).handle || l.handler).apply(
												s.elem,
												p,
											)) &&
			...
			(function () {
				...
				[0, 0].sort(function () {
						...
						if (x.length > 1 && i.exec(e))
							...
							for (
								g = a
									...
									: n.find(
											x.pop(),
											1 !== x.length || ('~' !== x[0] && '+' !== x[0]) || !t.parentNode
												? t
												: t.parentNode,
											w,
									  ),
						...
						if ((p || (p = c), p || n.error(y || e), '[object Array]' === m.call(p)))
							if (_)
								if (t && 1 === t.nodeType)
									for (b = 0; null != p[b]; b++)
										p[b] &&
											(!0 === p[b] || (1 === p[b].nodeType && n.contains(t, p[b]))) &&
											r.push(c[b]);
					...
					(n.filter = function (e, t, r, i) {
						for (
							var a, s, u, l, c, f, d, p, h, m = e, g = [], y = t, v = t && t[0] && n.isXML(t[0]);
							e && t.length;
			...
			xt.fn.extend({
				...
				closest: function (e, t) {
					...
					for (
						i = se.test(e) || 'string' != typeof e ? xt(e, t || this.context) : 0,
							n = 0,
							r = this.length;
						n < r;
						n++
			...
			xt.extend({
				...
				dir: function (e, t, n) {
					for (
						var r = [], o = e[t];
						o && 9 !== o.nodeType && (void 0 === n || 1 !== o.nodeType || !xt(o).is(n));
							...
							if (
								...
								try {
									for (; n < r; n++)
										(t = this[n] || {}),
											1 === t.nodeType &&
												(xt.cleanData(t.getElementsByTagName('*')), (t.innerHTML = e));
									t = 0;
								} catch (e) {}
							}
						...
						d.length &&
							xt.each(d, function (e, t) {
								t.src
									...
									: xt.globalEval(
											(t.text || t.textContent || t.innerHTML || '').replace(we, '/*$0*/'),
									  ),
			...
			xt.extend({
				clone: function (e, t, n) {
					var r,
						...
						i,
						a =
							xt.support.html5Clone || xt.isXMLDoc(e) || !ve.test('<' + e.nodeName + '>')
								? e.cloneNode(!0)
								: y(e);
					if (
						!(
		...
		(tt = Je.exec(et.toLowerCase()) || []),
						...
						? ((r = e.indexOf(' ')),
						  ...
						  t &&
								(xt.isFunction(t)
									? ((n = t), (t = void 0))
									: 'object' == typeof t &&
									  ((t = xt.param(t, xt.ajaxSettings.traditional)), (i = 'POST'))),
						  (a = this),
						  xt.ajax({
								url: e,
								type: i,
								...
								complete: function (e, t, r) {
									(r = e.responseText),
										e.isResolved() &&
											...
											a.html(o ? xt('<div>').append(r.replace(qe, '')).find(o) : r)),
										n && a.each(n, [r, t, e]);
								},
						  }),
						  this)
					...
					function n(e, t, n, c) {
						if (2 !== y) {
							...
							(w.status = e),
								...
								s.fireWith(o, [w, x]),
								v &&
									(i.trigger('ajaxComplete', [w, r]), --xt.active || xt.event.trigger('ajaxStop'));
						}
					}
			...
			xt.ajaxPrefilter('json jsonp', function (e, t, n) {
				...
				if (
					...
					return (
						(o = e.jsonpCallback =
							xt.isFunction(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback),
						(i = window[o]),
						(a = e.url),
						(s = e.data),
						(u = '$1' + o + '$2'),
									...
									(t = function (n, i) {
										...
										try {
											if (t && (i || 4 === a.readyState))
												if (
													((t = void 0),
													o && ((a.onreadystatechange = xt.noop), it && delete st[o]),
													i)
												)
					...
					function o() {
							...
							if (
								...
								xt.isArray(n)
									...
									: (p.animatedProperties[t] =
											(p.specialEasing && p.specialEasing[t]) || p.easing || 'swing'),
								('hide' === n && m) || ('show' === n && !m))
							)
						...
						for (r in e)
							(o = new xt.fx(this, p, r)),
								...
								ft.test(n)
									? ((d =
											xt._data(this, 'toggle' + r) || ('toggle' === n ? (m ? 'show' : 'hide') : 0)),
									  d
											? (xt._data(this, 'toggle' + r, 'show' === d ? 'hide' : 'show'), o[d]())
											: o[n]())
									: ((u = dt.exec(n)),
									  (l = o.cur()),
									  u
			...
			(xt.fx.prototype = {
				...
				hide: function () {
					(this.options.orig[this.prop] =
						xt._data(this.elem, 'fxshow' + this.prop) || xt.style(this.elem, this.prop)),
						(this.options.hide = !0),
			...
			!(function (t, n) {
				...
				function x(e) {
					for (var t, n, r, o, i = 0; i < e.length; ) {
						for (
							o = w(e[i]).split('-'), t = o.length, n = w(e[i + 1]), n = n ? n.split('-') : null;
							t > 0;
				...
				function j(e, t, n) {
					var r = '' + Math.abs(e),
						o = t - r.length;
					return (
						(e >= 0 ? (n ? '+' : '') : '-') + ('' + Math.pow(10, Math.max(0, o))).substr(1) + r
					);
				}
				function A(e, t, n, r) {
					var o = r;
				...
				function Be(e) {
					return (
						this._isUTC &&
							(this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract(Ye(this), 'm')),
						this
					);
				}
				function Ve() {
				...
				function Sn(e) {
					...
					if ('month' === (e = M(e)) || 'year' === e)
						return (
							(t = this._days + r / 864e5), (n = this._months + kn(t)), 'month' === e ? n : n / 12
						);
			...
			void 0 !== e && e.exports && (t = e.exports = V),
				...
				(V.map = V.collect =
					function (e, t, n) {
						var r, o, i, a, s;
						for (
							t = l(t, n), r = !m(e) && V.keys(e), o = (r || e).length, i = Array(o), a = 0;
							a < o;
							a++
						)
				...
				(V.find = V.detect =
					function (e, t, n) {
						var r;
						if (void 0 !== (r = m(e) ? V.findIndex(e, t, n) : V.findKey(e, t, n)) && -1 !== r)
							return e[r];
					}),
				(V.filter = V.select =
					function (e, t, n) {
				...
				(V.mapObject = function (e, t, n) {
					var r, o, i, a, s;
					for (t = l(t, n), r = V.keys(e), o = r.length, i = {}, s = 0; s < o; s++)
						(a = r[s]), (i[a] = t(e[a], a, e));
					return i;
				}),
				(V.pairs = function (e) {
		...
		!(function (e) {
			...
			function r(w) {
				...
				function M(t) {
					...
					function w(t) {
						1 == t.which &&
							((Y = !1), e(document).unbind('mouseup', w), V.is('.opened') && e(B).get(0).focus());
					}
					function x() {
						var e, t;
						W && ((W = !1), V.find('.tvcolorpicker-swatch.active').removeClass('active')),
							...
							a(g(B.val().toUpperCase()), e) ||
								((t = h(e)), B.data('tvcolorpicker-custom-color', t), T.call(B, t));
					}
					var S,
						M,
						O,
	...
	function (e, t, n) {
		...
		e.exports =
			...
			n(36)(function () {
				...
				? function (e, t) {
						for (
							var n, u, l, c, f, d = a(e), p = arguments.length, h = 1, m = o.f, g = i.f;
							p > h;

						)
							for (
								n = s(arguments[h++]), u = m ? r(n).concat(m(n)) : r(n), l = u.length, c = 0;
								l > c;
			...
			'Array',
			{
				from: function (e) {
					var t,
						...
						v = c(d);
					if (
						(g && (m = r(m, h > 2 ? arguments[2] : void 0, 2)), void 0 == v || (p == Array && s(v)))
					)
	...
	function (e, t, n) {
		...
		r(r.S + r.F * (f || d), 'Reflect', {
			construct: function (e, t) {
				var n, r, u, p, h;
				if ((i(e), a(t), (n = arguments.length < 3 ? e : i(arguments[2])), d && !f))
					return c(e, t, n);
				if (e == n) {
					switch (t.length) {
						case 0:
							...
							flip: {
								left: function (e, t) {
									var n,
										...
										h = -2 * t.offset[0];
									c < 0
										? ((n = e.left + d + p + h + t.collisionWidth - s - i) < 0 || n < a(c)) &&
										  (e.left += d + p + h)
										: f > 0 &&
										  ((r = e.left - t.collisionPosition.marginLeft + d + p + h - u) > 0 ||
												a(r) < f) &&
										  (e.left += d + p + h);
								},
								top: function (e, t) {
									var n,
										...
										m = -2 * t.offset[1];
									c < 0
										? ((r = e.top + p + h + m + t.collisionHeight - s - i) < 0 || r < a(c)) &&
										  (e.top += p + h + m)
										: f > 0 &&
										  ((n = e.top - t.collisionPosition.marginTop + p + h + m - u) > 0 ||
												a(n) < f) &&
										  (e.top += p + h + m);
								},
							},
	...
	function (e, t, n) {
		...
		!(function (n, a) {
			...
			function u(t, n) {
				...
				function i(e) {
					if (('string' == typeof e && (e = e.split(w, 2)), !g(e) || 2 !== e.length))
				...
				_getOptions: function (n, o, i, s, u) {
					...
					arguments[0].each(function (n) {
						var o,
							...
							p = e('<li>');
						d.is(':selected') &&
							(i.sbSelector.text(d.text()), r(i, i.sbSelector, d, !0), (i.isSelected = a)),
										...
										h
											? ((n = !0 === n ? 'infinite' : n),
											  ...
											  r.contains('theme-dark')
													? (this.style[g] =
															'highlight-animation-theme-dark 0.4s ease-in-out ' + n + ' alternate')
													: (this.style[g] =
															'highlight-animation 0.4s ease-in-out ' + n + ' alternate'))
											: ((a = e(this)),
											  a.data(l, n),
											  a.data(c, e.extend({}, o || {})),
											  a.is(':animated') || i(a));
	...
	function (e, t, n) {
		...
		function p(e) {
			...
			for (t in e)
				e.hasOwnProperty(t) &&
					((n = e[t]),
					(An.hasOwnProperty(t) && An[t] === n) || (An[t] && r('102', t), (An[t] = n), (o = !0)));
			o && c();
		}
		function h(e, t, n, r) {
		...
		function F() {
			return (
				!Qn &&
					ni.canUseDOM &&
					(Qn = 'textContent' in document.documentElement ? 'textContent' : 'innerText'),
				Qn
			);
		}
		function R() {
		...
		function Ae(e) {
			return (
				Object.prototype.hasOwnProperty.call(e, Wr) || ((e[Wr] = Yr++), (Hr[e[Wr]] = {})), Hr[e[Wr]]
			);
		}
		function Fe(e) {
				...
				(l = s.expirationTime),
					l > i
						...
						: (u || ((n.first = s.next), null === n.first && (n.last = null)),
						  ...
						  null !== s.callback &&
								((l = n.callbackList), null === l && (l = n.callbackList = []), l.push(s))),
					(s = s.next);
			return (
				null !== n.callbackList
					? (t.effectTag |= 32)
		...
		function Mt(e, t) {
			...
			function v(e, r, a, u) {
				...
				for (l = null, c = null, f = r, d = r = 0, p = null; null !== f && d < a.length; d++) {
					if (
						(f.index > d ? ((p = f), (f = null)) : (p = f.sibling), null === (h = g(e, f, a[d], u)))
					) {
						null === f && (f = p);
						break;
					}
				...
				if (null === f) {
					for (; d < a.length; d++)
						(f = m(e, a[d], u)) &&
							((r = s(f, r, d)), null === c ? (l = f) : (c.sibling = f), (c = f));
					return l;
				}
				...
				if (null === f) {
					for (; !h.done; d++, h = u.next())
						null !== (h = m(e, h.value, l)) &&
							((a = s(h, a, d)), null === c ? (b = h) : (c.sibling = h), (c = h));
					return b;
				}
				...
				(g = e.updateClassInstance),
				{
					beginWork: function (e, t, n) {
						...
						switch (t.tag) {
							...
							case 1:
								e: {
									if (((i = t.type), (n = t.pendingProps), (o = t.memoizedProps), ro.current))
										null === n && (n = o);
									else if (null === n || o === n) {
										t = f(e, t);
										break e;
		...
		function jt(e) {
				...
				for (var t, n, r, o, i, a; ; ) {
					if (
						...
						for (
							2 !== o.tag && 3 !== o.tag
								? (i = 0)
								: ((i = o.updateQueue), (i = null === i ? 0 : i.expirationTime)),
								a = o.child;
							null !== a;
			...
			function s(e, t) {
				var n, o, s, l;
				if (
					(I && r('243'), (I = !0), (e.isReadyForCommit = !1), e !== Y || t !== W || null === H)
				) {
				...
				if (3 === e.tag) (u = e), c(e) && ($ = !0);
					...
					for (n = e.return; null !== n && null === u; ) {
						if (
							...
							if (G || (null !== V && (V.has(n) || (null !== n.alternate && V.has(n.alternate)))))
								return null;
							(u = null), (f = !1);
						}
						n = n.return;
				...
				if ((Z && r('245'), (Z = !0), n <= g())) {
					...
					(o = e.finishedWork),
						null !== o
							...
							: ((e.finishedWork = null),
							  null !== (o = s(e, n)) &&
									(w() ? (e.finishedWork = o) : (e.remainingExpirationTime = t(o))));
				Z = !1;
			}
			function w() {
		...
		function Ft(e) {
			return (
				!!Fo.hasOwnProperty(e) ||
				(!Ao.hasOwnProperty(e) && (jo.test(e) ? (Fo[e] = !0) : ((Ao[e] = !0), !1)))
			);
		}
		function Rt(e, t, n) {
			var r,
			...
			switch (t) {
				...
				case 'select':
					(e.multiple = !!n.multiple),
						...
						null != t
							? qt(e, !!n.multiple, t, !1)
							: null != n.defaultValue && qt(e, !!n.multiple, n.defaultValue, !0);
					break;
				default:
				...
				injectDOMPropertyConfig: function (e) {
					...
					for (t in s)
						_n.hasOwnProperty(t) && r('48', t),
							...
							1 >= n.hasBooleanValue + n.hasNumericValue + n.hasOverloadedBooleanValue ||
								r('50', t),
					...
					return ('topMouseOver' === e && (n.relatedTarget || n.fromElement)) ||
						...
						: ((o =
								r.window === r
									...
									: window),
						  'topMouseOut' === e
								? ((e = t), (t = (t = n.relatedTarget || n.toElement) ? T(t) : null))
								: (e = null),
						  e === t
								? null
								: ((i = null == e ? o : S(e)),
