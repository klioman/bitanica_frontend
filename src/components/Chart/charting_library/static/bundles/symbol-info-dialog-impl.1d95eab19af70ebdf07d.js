webpackJsonp([5], {
	...
	1206: function (e, t, n) {
		...
		function r(e) {
			a.render(
				s.createElement(u.TransitionGroup, { component: 'div' }, Array.from(m.values())),
				d,
				e,
			);
		}
		...
		function o(e) {
			...
			return (
				e.text
					...
					: e.html &&
					  (t = i.createElement('span', { dangerouslySetInnerHTML: { __html: e.html } })),
				(n = r.message),
				e.isError && (n += ' ' + r.error),
				i.createElement(
	...
	415: function (e, t, n) {
		...
		(function (e, o) {
				...
				r({ isOpened: !1 }),
					...
					null != e &&
						...
						(i = [
							{
								title: $.t('Symbol Name'),
								propName: o.enabled('charting_library_base') ? 'name' : 'pro_name',
							},
			...
			function r(e) {
				E || ((E = document.createElement('div')), document.body.appendChild(E)),
			...
			function l(e, t) {
				...
				for (n = 0; n < t.length; n++)
					(o = t[n].propName) in e &&
						...
						'minmove2' === o && e.minmove2 > 0 && !e.fractional && e.pricescale
							? ((t[n].value = new w(e.pricescale / i).format(i / e.pricescale)),
				...
				return (
					(r =
						...
						(e.listed_exchange &&
							['QUANDL', 'BSE_EOD', 'NSE_EOD', 'LSE_EOD'].indexOf(e.listed_exchange) >= 0)),
					r && c(t),
					s
				);
			}
