webpackJsonp([3], {
		...
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t) {
				...
				return (
					...
					(p = h(a)),
					this.bindControl(
						new l(o, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility'),
					),
					this.bindControl(
						new s(p, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0),
					),
					d
				);
			}),
				...
				for (
					this._div = $(document.createElement('div')).addClass('property-page'),
						...
						e &&
							...
							this.bindControl(
								new l(i, e.visible, !0, this.model(), 'Change Fib Retracement Line Visibility'),
							),
							(n = $("<td class='colorpicker-cell'>").appendTo(o)),
							(a = h(n)),
							this.bindControl(
								new s(a, e.color, !0, this.model(), 'Change Fib Retracement Line Color', 0),
							),
							(r = $('<td>').appendTo(o)),
							(C = b()),
							C.appendTo(r),
							this.bindControl(
								new p(C, e.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'),
							),
							(y = $('<td>').appendTo(o)),
							(g = c()),
							g.render().appendTo(y),
						...
						C.appendTo(r),
						this.bindControl(
							new p(C, T.linewidth, parseInt, this.model(), 'Change Fib Retracement Line Width'),
						),
						y = $('<td>').appendTo(w),
						g = c(),
						g.render().appendTo(y),
				...
				(i.prototype.prepareLayout = function () {
					...
					if (
						(t.enabled('chart_property_page_style') &&
							...
							this._pane &&
								(-1 !== this._pane.leftPriceScale().dataSources().indexOf(this._series)
									? (M = 'left')
									: -1 !== this._pane.rightPriceScale().dataSources().indexOf(this._series)
									? (M = 'right')
						...
						t.enabled('chart_property_page_scales') &&
							...
							this.bindControl(
								new c(U, this._scaleProperty.autoScale, !0, this.model(), 'Auto Scale', Y),
							),
							this.bindControl(
								new y(U, this._scaleProperty.autoScaleDisabled, !0, this.model(), 'Auto Scale'),
							),
							...
							this.bindControl(
								new c(K, this._scaleProperty.percentage, !0, this.model(), 'Scale Percentage', J),
							),
							this.bindControl(
								new y(
									K,
							...
							this.bindControl(
								new c(Z, this._scaleProperty.log, !0, this.model(), 'Log Scale', ee),
							),
							this.bindControl(
								new y(Z, this._scaleProperty.logDisabled, !0, this.model(), 'Log Scale'),
							),
							...
							this.bindControl(
								new c(ie, this._scaleProperty.lockScale, !0, this.model(), 'Change lock scale', ae),
							),
							...
							t.enabled('support_multicharts') &&
								...
								this.bindControl(
									new g(le, this._model.trackTime(), null, this.model(), 'Change track time'),
								)),
							...
							Te.push(p(0)),
							this.bindControl(
								new h(ye, $e.defaultRightOffsetProperty(), Te, !0, this.model(), 'Right Margin'),
							),
							...
							(He = $('<div class="property-page-column-2">').append(N).append(se)),
							(Ge = $('<div class="property-page-column-2">').append(ke)),
							(R = $('<div>').css('min-width', '520px').data('layout-tab', a.TabNames.scales)),
						...
						t.enabled('chart_property_page_background') &&
							...
							(ut = v()),
							$('<td>').append(ut).appendTo(this.addRow(Ke).prepend('<td/><td/>')),
							this.bindControl(
								new b(
									ut,
						...
						(zt = $('<select>' + Vt + '</select>')),
							zt.appendTo(Wt),
							this.bindControl(
								new C(zt, this._property.timezone, null, !0, this.model(), 'Change Timezone'),
							),
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $(document.createElement('table'))),
					...
					this.bindControl(
						new p(h, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
					),
					this.bindControl(
						new s(i, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new s(
							n,
					...
					(b = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
						.append($(document.createElement('td')).attr({ width: 1 }).append(o))
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $(document.createElement('table'))),
					...
					this.bindControl(
						new l(t, this._linetool.properties().color, !0, this.model(), 'Change Arc Line Color'),
					),
					this.bindControl(
						new l(
							n,
		...
		inherit(i, a),
			...
			(n.prototype.prepareLayout = function () {
				...
				(this._table = $(document.createElement('table'))),
					...
					(s = [p(l.price.value())]),
					this.bindControl(
						new c(i, l.price, s, !1, this.model(), 'Change ' + this._linetool + ' point price'),
					),
					this.bindBarIndex(
						l.bar,
						r,
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					this.bindControl(
						new p(t, this._linetool.properties().linecolor, !0, this.model(), 'Change Brush Color'),
					),
					this.bindControl(
						new r(
							e,
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				this.bindControl(
					...
					this.bindControl(
						new r(T, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap'),
					),
					this.bindControl(
						new r(w, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new r(
							_,
					...
					$(document.createElement('tr'))
						...
						.append($(document.createElement('td')).attr({ width: 1 }).append(a))
						.append($(document.createElement('td')).attr({ width: 1 }).append(w))
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					this.bindControl(
						new l(n, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
					),
					this.bindControl(
						new r(
							h,
					...
					this.bindControl(
						new r(c, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
					),
					this.bindControl(
						new l(
							b,
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					(B = $("<label style='display:block'>").append(x).append($.t('Show Prices'))),
					...
					this.bindControl(
						new r(b, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
					),
					this.bindControl(
						new p(a, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
					),
					this.bindControl(
			...
			(i.prototype.addLevelEditor = function (e, t, o) {
				...
				m.appendTo(this._table),
					...
					e ||
						...
						_.render().appendTo(w),
						this.bindControl(
							new l(_, t.linestyle, parseInt, !0, this.model(), 'Change Fib Circle Style'),
						)),
		...
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t, o) {
				...
				m.appendTo(this._table),
					...
					this.bindControl(
						new p(n, t.visible, !0, this.model(), 'Change Fib Speed Resistance Arcs Visibility'),
					),
					this.bindControl(
						new s(y, t.color, !0, this.model(), 'Change Fib Speed Resistance Arcs Line Color', 0),
					),
					this.bindControl(
						new d(T, t.linewidth, !0, this.model(), 'Change Fib Speed Resistance Arcs Width'),
					);
			}),
			(i.prototype.prepareLayout = function () {
				var e, t, o, i, n, a, r;
		...
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t, o) {
				...
				b.appendTo(e),
					...
					s.css('width', '70px'),
					this.bindControl(
						new r(n, o.visible, !0, this.model(), 'Change Gann Square Line Visibility'),
					),
		...
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t, o) {
				...
				m.appendTo(this._table),
					...
					_.render().appendTo(w),
					this.bindControl(
						new l(n, t.visible, !0, this.model(), 'Change Pitchfork Line Visibility'),
					),
					this.bindControl(new p(y, t.color, !0, this.model(), 'Change Pitchfork Line Color', 0)),
					this.bindControl(
						new s(_, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfork Line Style'),
					),
					this.bindControl(
						new d(T, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'),
					);
			}),
			(i.prototype.prepareLayout = function () {
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					this.bindControl(
						new p(u, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new p(
							C,
		...
		o(242),
			...
			(i.prototype.addOneColorPropertyWidget = function (e) {
				var t = this.createOneColorForAllLinesWidget(),
					o = $('<tr>');
				o.append($('<td>')).append($('<td>')).append(t.editor).append($('<td>').append(t.label)),
					o.appendTo(e);
			}),
			(i.prototype.prepareLayout = function () {
				var e,
				...
				this.addOneColorPropertyWidget(R),
					...
					this.bindControl(
						new s(A, i.arcsBackground.fillBackground, !0, t, 'Change Gann Square Filling'),
					),
					this.bindControl(
						new d(
							W,
					...
					(Z = $('<table class="property-page" cellspacing="0" cellpadding="2"><tr>')
						.append($(document.createElement('td')).attr({ width: 1 }).append(Q))
						...
						.append($(document.createElement('td')).css('vertical-align', 'top').append(Y))
						.append($('</tr></table>'))),
		...
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t, o, i) {
				...
				m.appendTo(this._tbody),
					...
					_.render().appendTo(w),
					this.bindControl(
						new r(b, t.visible, !0, this.model(), 'Change Gann Fan Line Visibility'),
					),
					this.bindControl(new l(y, t.color, !0, this.model(), 'Change Gann Fan Line Color', 0)),
					this.bindControl(
						new p(_, t.linestyle, parseInt, !0, this.model(), 'Change Gann Fan Line Style'),
					),
		...
		inherit(i, n),
			...
			(i.prototype.prepareLayout = function () {
				...
				for (
					...
					(p = 'hlevel' + l),
						this.addLevelEditor(n, $.t('Level {0}').format(l), this._linetool.properties()[p]);
				for (l = 1; l <= 7; l++)
					(p = 'vlevel' + l),
						this.addLevelEditor(a, $.t('Level {0}').format(l), this._linetool.properties()[p]);
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $(document.createElement('table'))),
					...
					this.bindControl(
						new r(i, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new r(
							n,
		...
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				...
				this.bindControl(
					...
					this.bindControl(
						new p(r, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
					),
					this.bindControl(
						new s(h, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
					),
					this.bindControl(
						new l(
							c,
					...
					this.bindControl(
						new d(u, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new d(
							C,
					...
					$(document.createElement('tr'))
						.append($(document.createElement('td')).attr({ width: 1 }).append(n))
						.append($(document.createElement('td')).attr({ width: 1 }).append(r))
						.append($(document.createElement('td')).attr({ width: 1 }).append(a))
						.append($(document.createElement('td')).attr({ width: 1 }).append(u))
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $(document.createElement('table'))),
					...
					this.bindControl(
						new r(g, f.fillBackground, !0, this.model(), 'Change Parallel Channel Fill Background'),
					),
					this.bindControl(
						new r(c, f.showMidline, !0, this.model(), 'Change Parallel Channel Show Center Line'),
					),
					this.bindControl(
						new r(_, f.extendLeft, !0, this.model(), 'Change Parallel Channel Extending Left'),
					),
					this.bindControl(
						new r(m, f.extendRight, !0, this.model(), 'Change Parallel Channel Extending Right'),
					),
					this.bindControl(
						new l(i, f.linecolor, !0, this.model(), 'Change Parallel Channel Color'),
					),
					this.bindControl(
						new p(o, f.linestyle, parseInt, !0, this.model(), 'Change Parallel Channel Style'),
					),
					this.bindControl(
						new s(t, f.linewidth, !0, this.model(), 'Change Parallel Channel Width'),
					),
					this.bindControl(
						new l(C, f.midlinecolor, !0, this.model(), 'Change Parallel Channel Middle Color'),
					),
					this.bindControl(
						new p(
							u,
					...
					this.bindControl(
						new s(b, f.midlinewidth, !0, this.model(), 'Change Parallel Channel Middle Width'),
					),
					this.bindControl(
						new l(
							T,
		...
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t, o) {
				...
				m.appendTo(this._table),
					...
					this.bindControl(new p(y, t.color, !0, this.model(), 'Change Pitchfork Line Color'), 0),
					this.bindControl(
						new s(_, t.linestyle, parseInt, !0, this.model(), 'Change Pitchfan Line Style'),
					),
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = m.add(f).add(L)),
					...
					$('<td>').append(t).appendTo(o),
					(i = $('<tr>').appendTo(f)),
					(n = $('<td>').appendTo(i).css({ 'vertical-align': 'top', width: '50%' })),
					(a = $('<td>').appendTo(i).css({ 'vertical-align': 'top', width: '50%' })),
	...
	1122: function (e, t, o) {
		...
		(i.prototype.attachSource = function (e, t) {
			...
			(n.prototype.prepareLayout = function () {
				...
				this.bindControl(
					new s(n, this._linetool.properties().color, !0, this.model(), 'Change Text Color'),
				),
					this.bindControl(
						new p(
							r,
					...
					this.bindControl(
						new l(c, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
					),
					this.bindControl(
						new s(
							b,
					...
					this.bindControl(
						new d(y, this._linetool.properties().wordWrap, !0, this.model(), 'Change Text Wrap'),
					),
					this.bindControl(
						new d(g, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new d(
							T,
					...
					$(document.createElement('tr'))
						...
						.append($(document.createElement('td')).attr({ width: 1 }).append(h))
						.append($(document.createElement('td')).attr({ width: 1 }).append(r))
						.append($(document.createElement('td')).attr({ width: 1 }).append(g))
		...
		inherit(i, n),
			(i.prototype.addLevelEditor = function (e, t, o) {
				...
				m.appendTo(this._table),
					...
					this.bindControl(
						new p(T, t.linewidth, parseInt, this.model(), 'Change Pitchfork Line Width'),
					);
			}),
			(i.prototype.prepareLayout = function () {
		...
		inherit(i, n),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					$('<td>').append(T).appendTo(n),
					this.bindControl(
						new l(T, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
					),
					(w = $('<input type="checkbox">')),
					(_ = $('<input type="checkbox">')),
					(m = $('<input type="checkbox">')),
				...
				(i.prototype.prepareLayout = function () {
					...
					(this._block = $('<table class="property-page">')),
						...
						t.enabled('seconds_resolution') &&
							...
							(n = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i)),
							...
							this.bindControl(
								new r(n, e.seconds, !0, this.model(), 'Change Line Tool Visibility On Seconds'),
							),
							this.bindControl(
								new l(
									p,
						...
						(d = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i)),
						$('<td>').css('padding-right', '15px').append(i).appendTo(o),
						(a = $("<input type='text'>").addClass('ticker-text')),
						$('<td>').append(a).appendTo(o),
						(p = $('<div>').addClass('slider-range ui-slider-horizontal').slider()),
						...
						$('<td>').append(s).appendTo(o),
						this.bindControl(
							new r(d, e.minutes, !0, this.model(), 'Change Line Tool Visibility On Minutes'),
						),
						this.bindControl(
							new l(
								p,
						...
						(h = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i)),
						$('<td>').append(i).appendTo(o),
						(a = $("<input type='text'>").addClass('ticker-text')),
						$('<td>').append(a).appendTo(o),
						(p = $('<div>').addClass('slider-range ui-slider-horizontal').slider()),
						...
						$('<td>').append(s).appendTo(o),
						this.bindControl(
							new r(h, e.hours, !0, this.model(), 'Change Line Tool Visibility On Hours'),
						),
						this.bindControl(
							new l(
								p,
						...
						(c = $("<input type='checkbox'>").addClass('visibility-checker').prependTo(i)),
						$('<td>').append(i).appendTo(o),
						(a = $("<input type='text'>").addClass('ticker-text')),
						$('<td>').append(a).appendTo(o),
						(p = $('<div>').addClass('slider-range ui-slider-horizontal').slider()),
						...
						$('<td>').append(s).appendTo(o),
						this.bindControl(
							new r(c, e.days, !0, this.model(), 'Change Line Tool Visibility On Days'),
						),
						this.bindControl(
							new l(
								p,
						...
						$('<td>').append(i).appendTo(o),
						this.bindControl(
							new r(b, e.weeks, !0, this.model(), 'Change Line Tool Visibility On Weeks'),
						),
						(o = $('<tr>').css('height', '29px').appendTo(this._block)),
						...
						$('<td>').append(i).appendTo(o),
						this.bindControl(
							new r(u, e.months, !0, this.model(), 'Change Line Tool Visibility On Months'),
						),
						this.loadData();
				}),
				(i.prototype.widget = function () {
		...
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $(document.createElement('table'))),
					...
					this.bindControl(
						new r(e, this._property.inputs.source, null, !0, this.model(), 'Change Price Source'),
					),
					this.loadData();
			}),
			(i.prototype.widget = function () {
		...
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					this.bindControl(
						new r(t, this._study.properties().font, null, !0, this.model(), 'Change Pivots Font'),
					),
					this.bindControl(
						new r(
							e,
					...
					this.bindControl(
						new l(o, this._property.levelsStyle.showLabels, !0, g.model(), 'Show Pivot Labels'),
					),
			...
			(i.prototype._setStdInput = function (e, t, o) {
				...
				if (e) {
					if (
						...
						($('<td>').addClass('propertypage-name-label').append(C).appendTo(a),
						...
						for (y = $('<select id="' + n + '">').appendTo(T), w = 0; w < e.options.length; w++)
							(_ = e.options[w]),
								_ instanceof jQuery
									? _.appendTo(y)
									: $('<option value="' + _ + '">' + _ + '</option>').appendTo(y);
						!0 !== o &&
							this.bindControl(new c(y, this._property.inputs[i], null, !0, this.model(), r));
					} else
			...
			(i.prototype._setQtyInputs = function (e) {
				function t(e) {
					return (
						...
						isNaN(e) || e < 0
							? 0
							: ('percent_of_equity' !== a.val() ? (e = parseInt(e)) : e > 100 && (e = 100), e)
					);
				}
				var o,
					i,
			...
			(i.prototype._setCommissionInputs = function (e) {
				function t(e) {
					return (
						...
						isNaN(e) || e < 0
							? 0
							: ('percent' !== c.val() ? (e = parseFloat(e)) : e > 100 && (e = 100), e)
					);
				}
		...
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					this.bindControl(
						new l(t, m.styles.vol.plottype, parseInt, !0, this.model(), 'Change Volume Plot Style'),
					),
					(i =
					...
					this.bindControl(
						new r(c, m.styles.vol.trackPrice, !0, this.model(), 'Change Price Line'),
					),
					(b = m.styles.vol_ma),
					...
					this.bindControl(
						new l(C, b.plottype, parseInt, !0, this.model(), 'Change Volume MA Plot Style'),
					),
					$('<td>').html('&nbsp;').appendTo(u),
					(y = this.createColorPicker()),
					$('<td>').append(y).appendTo(u),
					this.bindControl(
						new s(y, b.color, !0, this.model(), 'Change Volume MA color', b.transparency),
					),
					(g = d()),
			...
			inherit(i, a),
					...
					for (i = i || {}, c = {}, b = this, u = 0; u < e.inputs.length; u++) {
						...
						if (
							...
							if (
								...
								m.text($.t(g)),
								(f = $(
									'<td' + (i.valueColspan ? ' colspan = "' + i.valueColspan + '"' : '') + '/>',
								)),
								f.appendTo(_),
								(L = null),
								C.options)
								...
								for (L = $('<select/>'), v = 0; v < C.options.length; v++)
									(k = C.options[v]),
										$("<option value='" + k + "'>" + $.t(k) + '</option>').appendTo(L);
							else
								(L = $('<input/>')),
									'bool' === C.type ? L.attr('type', 'checkbox') : L.attr('type', 'text');
							L.appendTo(f),
								L.css('width', '100px'),
								(S = 'Change ' + g),
								C.options
				...
				(i.prototype._prepareSeriesStyleLayout = function (e, o, i, n) {
					...
					nt.addClass('property-wide-select'),
						...
						$(
							'<option value=' + C.STYLE_HOLLOW_CANDLES + '>' + $.t('Hollow Candles') + '</option>',
						).appendTo(a),
						this._isJapaneseChartsAvailable() &&
							$(
								'<option value=' + C.STYLE_HEIKEN_ASHI + '>' + $.t('Heikin Ashi') + '</option>',
							).appendTo(a),
						$('<option value=' + C.STYLE_LINE + '>' + $.t('Line') + '</option>').appendTo(a),
						$('<option value=' + C.STYLE_AREA + '>' + $.t('Area') + '</option>').appendTo(a),
						$('<option value=' + C.STYLE_BASELINE + '>' + $.t('Baseline') + '</option>').appendTo(
							a,
						),
						...
						this.bindControl(
							new h(a, n.style, parseInt, !0, this.model(), 'Change Series Style', s),
						),
						...
						this.bindControl(
							new c(T, n.candleStyle.upColor, !0, this.model(), 'Change Candle Up Color'),
						),
						this.bindControl(
							new c(w, n.candleStyle.downColor, !0, this.model(), 'Change Candle Down Color'),
						),
						this.bindControl(
							new b(k, n.candleStyle.drawWick, !0, this.model(), 'Change Candle Wick Visibility'),
						),
						this.bindControl(
							new c(_, n.candleStyle.wickUpColor, !0, this.model(), 'Change Candle Wick Up Color'),
						),
						this.bindControl(
							new c(
								m,
						...
						this.bindControl(
							new c(z, n.barStyle.downColor, !0, this.model(), 'Change Bar Down Color'),
						),
						this.bindControl(
							new b(
								W,
						...
						this.bindControl(
							new b(V, n.barStyle.dontDrawOpen, !0, this.model(), 'Change HLC Bars'),
						),
						(M = g()),
						...
						$(
							'<option value=' + C.STYLE_LINE_TYPE_SIMPLE + '>' + $.t('Simple') + '</option>',
						).appendTo(G),
						$(
							'<option value=' +
						...
						$('<option value=' + C.STYLE_LINE_TYPE_STEP + '>' + $.t('Step') + '</option>').appendTo(
							G,
						),
						G.appendTo(H),
						...
						this.bindControl(
							new h(M, n.lineStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
						),
						this.bindControl(
						...
						this.bindControl(
							new u(U, n.lineStyle.linewidth, !0, this.model(), 'Change Line Width'),
						),
						n.haStyle &&
							...
							$('<td>').append(Q).appendTo(P),
							this.bindControl(
								new c(q, n.haStyle.upColor, !0, this.model(), 'Change Heikin Ashi Up Color'),
							),
							this.bindControl(
						...
						this._isJapaneseChartsAvailable() &&
							...
							this.bindControl(
								new c(oe, n.renkoStyle.upColor, !0, this.model(), 'Change Bar Up Color'),
							),
							this.bindControl(
								new c(ne, n.renkoStyle.downColor, !0, this.model(), 'Change Bar Down Color'),
							),
							this.bindControl(
								new c(
									re,
							...
							this.bindControl(
								new c(de, n.pbStyle.upColor, !0, this.model(), 'Change Bar Up Color'),
							),
							this.bindControl(
								new c(ce, n.pbStyle.downColor, !0, this.model(), 'Change Bar Down Color'),
							),
							this.bindControl(
								new c(
									ue,
							...
							this.bindControl(
								new c(he, n.pbStyle.borderUpColor, !0, this.model(), 'Change Border Bar Up Color'),
							),
							this.bindControl(
								new c(
									be,
							...
							this.bindControl(
								new c($e, n.kagiStyle.upColor, !0, this.model(), 'Change Bar Up Color'),
							),
							this.bindControl(
								new c(Te, n.kagiStyle.downColor, !0, this.model(), 'Change Bar Down Color'),
							),
							this.bindControl(
								new c(
									we,
							...
							this.bindControl(
								new c(me, n.pnfStyle.upColor, !0, this.model(), 'Change Bar Up Color'),
							),
							this.bindControl(
								new c(fe, n.pnfStyle.downColor, !0, this.model(), 'Change Bar Down Color'),
							),
							this.bindControl(
								new c(
									Le,
						...
						this.bindControl(
							new h(ke, n.areaStyle.priceSource, null, !0, this.model(), 'Change Price Source'),
						),
						this.bindControl(
							new c(Se, n.areaStyle.linecolor, !0, this.model(), 'Change Line Color'),
						),
						this.bindControl(
							new u(Pe, n.areaStyle.linewidth, !0, this.model(), 'Change Line Width'),
						),
						this.bindControl(
							new c(
								xe,
						...
						this.bindControl(
							new c(Ee, n.baselineStyle.topLineColor, !0, this.model(), 'Change Top Line Color'),
						),
						this.bindControl(
							new u(Fe, n.baselineStyle.topLineWidth, !0, this.model(), 'Change Top Line Width'),
						),
						(Ie = this.createColorPicker()),
						(De = y()),
	...
	1236: function (e, t, o) {
		...
		function i() {
			...
			return (
				...
				$('<option value="' + n.PlotType.StepLine + '">' + $.t('Step Line') + '</option>').appendTo(
					e,
				),
				$(
					'<option value="' + n.PlotType.Histogram + '">' + $.t('Histogram') + '</option>',
				).appendTo(e),
				$(
					'<option value="' +
						n.PlotType.Cross +
	...
	1266: function (e, t, o) {
		...
		function i() {
			var e = $('<select />');
			return (
				$('<option value="' + n.HHISTDIR_LEFTTORIGHT + '">' + $.t('Left') + '</option>').appendTo(
					e,
				),
				$('<option value="' + n.HHISTDIR_RIGHTTOLEFT + '">' + $.t('Right') + '</option>').appendTo(
					e,
				),
				e
			);
	...
	379: function (e, t, o) {
		...
		inherit(i, r),
			(i.prototype.prepareLayout = function () {
					...
					for (n = 0; n < s.childCount(); n++)
						(b = s[n]),
							(b.isHidden && b.isHidden.value()) ||
								...
								(v = this.createLabeledCell(L, f).appendTo(w).addClass('propertypage-name-label')),
								(P = $('<td/>')),
								P.appendTo(w),
							...
							M.isHidden ||
								...
								M.palette
									? ((w = $('<tr class="line"/>')),
									  ...
									  this.createLabeledCell(O, f).appendTo(w).addClass('propertypage-name-label'),
									  w.appendTo(this._table),
				...
				(Y = this._table.find('.visibility-switch.plot-visibility-switch')),
					...
					S.isScriptStrategy(t) &&
						((Q = this._prepareOrdersSwitches()), (this._table = this._table.add(Q))),
					this.loadData();
			}),
			(i.prototype._prepareOrdersSwitches = function () {
				...
				return (
					$('<label for="' + p + '">' + $.t('Trades on Chart') + '</label>').appendTo(
						$('<td>').appendTo(s),
					),
					...
					this.bindControl(
						new c(d, r.strategy.orders.visible, !0, this.model(), 'Trades on chart visibility'),
					),
					this.bindControl(
						new c(o, r.strategy.orders.showLabels, !0, this.model(), 'Signal labels visibility'),
					),
					this.bindControl(
						new b(o, r.strategy.orders.visible, !0, this.model(), 'Signal labels visibility', !0),
					),
					this.bindControl(
						new c(a, r.strategy.orders.showQty, !0, this.model(), 'Quantity visibility'),
					),
					this.bindControl(
						new b(a, r.strategy.orders.visible, !0, this.model(), 'Quantity visibility', !0),
					),
					l
				);
			}),
			(i.prototype._prepareLayoutForPlot = function (e, t) {
				...
				L
					...
					: ((o = $('<tr class="line"/>')),
					  ...
					  this.createLabeledCell(a, n).appendTo(o).addClass('propertypage-name-label'),
					  (r = $('<td/>')),
					  r.appendTo(o),
					  ...
					  this.bindControl(
							new C(s, _.linewidth, !0, this.model(), S, this._study.metaInfo().isTVScript),
					  ),
			...
			(i.prototype._prepareLayoutForBarsPlot = function (e, t) {
				...
				y.appendTo(this._table),
					...
					(n = s.title.value()),
					this.createLabeledCell(n, i).appendTo(y).addClass('propertypage-name-label'),
					h
			...
			(i.prototype._prepareLayoutForShapesPlot = function (e, t) {
				...
				L.appendTo(this._table),
					...
					this.createLabeledCell(n, i).appendTo(L).addClass('propertypage-name-label'),
					(a = $('<td/>')),
					a.appendTo(L),
					(r = _()),
					r.appendTo(a),
				...
				for (l in o.colors)
					(p = i.colors[l]),
						...
						!E &&
							...
							w.appendTo(T),
							this.bindControl(
								new C(w, p.width, !0, this.model(), n, this._study.metaInfo().isTVScript),
							),
							(_ = $('<td>')),
							_.appendTo(s),
							0 === r &&
			...
			(i.prototype._prepareLayoutForArrowsPlot = function (e, t) {
				...
				b.appendTo(this._table),
					...
					this.createLabeledCell(n, i).appendTo(b).addClass('propertypage-name-label'),
					(a = $('<td/>')),
					a.appendTo(b),
			...
			(i.prototype._findPlotPalette = function (e, t) {
				...
				if (this._study.isBarColorerPlot(i) || this._study.isBgColorerPlot(i))
					...
					for (o = 0; o < l.length; o++)
						if (
							l[o].target === n &&
							(this._study.isSelfColorerPlot(o) || this._study.isOHLCColorerPlot(o))
						) {
			...
			(i.prototype._prepareStudyPropertiesLayout = function () {
				...
				return (
					...
					'Compare@tv-basicstudies' === this._study.metaInfo().id &&
						...
						$('<td>').append(e).appendTo(t),
						this.bindControl(
							new h(e, this._study.properties().minTick, null, !0, this.model(), 'Change MinTick'),
						)),
			...
			(i.prototype._prepareFilledAreaBackground = function (e, t, o, i, n) {
				...
				return (
					...
					(a = $("<input type='checkbox' class='visibility-switch'/>")),
					a.appendTo(s),
					this.createLabeledCell(i, a).appendTo(p).addClass('propertypage-name-label'),
					(r = $('<td/>')),
					r.appendTo(p),
					r.addClass('colorpicker-cell'),
					(l = g(r)),
			...
			(i._createRow_hlines = function (e, t) {
				...
				$('<td>').append(l).appendTo(a),
					...
					t.enableText.value() &&
						...
						this.bindControl(
							new h(i, t.textPos, parseInt, !0, this.model(), 'Change ' + r + ' text position'),
						),
						(n = this.createFontSizeEditor()),
						$('<td colspan="2">').append(n).appendTo(a),
						this.bindControl(
							new h(n, t.fontSize, parseInt, !0, this.model(), 'Change ' + r + ' font size'),
						));
			}),
			(i._createRow_hhists = function (e, t) {
				...
				$('<td>').append(w).appendTo(T),
					...
					$('<td>').append(n).appendTo(T),
					this.bindControl(
						new h(n, t.direction, null, !0, this.model(), 'Change ' + b + ' Placement'),
					),
					(T = this.addRow(e)),
					(a = $("<input type='checkbox'>")),
					...
					this.bindControl(
						new c(a, t.showValues, !0, this.model(), 'Change ' + b + ' Show Values'),
					),
					(T = this.addRow(e)),
					(r = this.createColorPicker()),
					...
					this.bindControl(
						new u(r, t.valuesColor, !0, this.model(), 'Change ' + b + ' Text Color'),
					);
				for (d in t.colors)
					isNumber(parseInt(d, 10)) &&
						...
						this.bindControl(
							new u(g[d], t.colors[d], !0, this.model(), 'Change ' + C[d] + ' color'),
						));
			}),
			(i._createRow_backgrounds = function (e, t) {
				...
				$('<td>').append(i).appendTo(o),
					...
					this.bindControl(
						new u(a, t.color, !0, this.model(), 'Change ' + n + ' color', t.transparency),
					);
			}),
			...
			(i._createRow_trendchannels = function (e, t) {
				...
				$('<td>').append(i).appendTo(o),
					$('<td>').append(n).appendTo(o),
					this.bindControl(
						new u(n, t.color, !0, this.model(), 'Change ' + i + ' color', t.transparency),
					);
			}),
			(i._createRow_textmarks = function (e, t) {
				...
				$('<td>').append(i).appendTo(o),
					...
					this.bindControl(
						new u(a, t.fontColor, !0, this.model(), 'Change ' + i + ' text color', t.transparency),
					),
					this.bindControl(
						new h(l, t.fontSize, parseInt, !0, this.model(), 'Change ' + i + ' font size'),
					),
			...
			(i._createRow_shapemarks = function (e, t) {
				...
				r.attr('type', 'text'),
					...
					this.bindControl(new c(i, t.visible, !0, this.model(), 'Change ' + n + ' visibility')),
					this.bindControl(
						new u(a, t.color, !0, this.model(), 'Change ' + n + ' back color', t.transparency),
					),
		...
		inherit(i, r),
			...
			(n.prototype.prepareLayout = function () {
				...
				(this._widget = $('<div>')),
					...
					this.bindControl(
						new s(h, c.transparency, !0, this.model(), 'Change Guest Feed Transparency'),
					);
			}),
			(n.prototype.widget = function () {
				return this._widget;
		...
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				...
				(this._res = $('<div>')),
					...
					$('<td>').append(o).appendTo(i),
					$('<td>').append(e).appendTo(i),
					$('<td colspan="3">').append(t.render().css('display', 'block')).appendTo(i),
					(n = $("<input type='checkbox' class='visibility-switch'>")),
					...
					this.bindControl(
						new d(_, this._linetool.properties().text, null, !0, this.model(), 'Change Text'),
					),
					this.bindControl(
						new p(
							n,
					...
					this.bindControl(
						new h(r, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
					),
					this.bindControl(
						new p(y, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new p(
							g,
		...
		inherit(i, r),
			...
			(n.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					this.bindControl(
						new b(o, k.linecolor, !0, this.model(), 'Change Risk/Reward line Color'),
					),
					this.bindControl(
						new u(t, k.linewidth, !0, this.model(), 'Change Risk/Reward line width'),
					),
					this.bindControl(
						new b(
							n,
					...
					this.bindControl(
						new C(l, k.fontsize, parseInt, !0, this.model(), 'Change Text Font Size'),
					),
		...
		inherit(i, a),
			(i.prototype.prepareLayout = function () {
				...
				(this._table = $('<table class="property-page" cellspacing="0" cellpadding="2">')),
					...
					this.bindControl(
						new b(p, this._linetool.properties().font, null, !0, this.model(), 'Change Text Font'),
					),
					this.bindControl(
						new h(r, this._linetool.properties().textcolor, !0, this.model(), 'Change Text Color'),
					),
					this.bindControl(
						new c(s, this._linetool.properties().bold, !0, this.model(), 'Change Text Font Bold'),
					),
					this.bindControl(
						new c(
							d,
