							...
							l.__awaiter(t, void 0, void 0, function () {
								...
								return l.__generator(this, function (r) {
									switch (r.label) {
										case 0:
											return (
												(t = this._chartWidgetCollection), (e = t.metaInfo.name.value()), [4, a(e)]
											);
										case 1:
							...
							l.__awaiter(t, void 0, void 0, function () {
								...
								return l.__generator(this, function (a) {
									switch (a.label) {
										case 0:
											return (
												(t = this._chartWidgetCollection), (e = t.metaInfo.name.value()), [4, c()]
											);
										case 1:
					...
					(t.prototype._saveCurrentChartAsNewWithTitle = function (t) {
						...
						v.enabled('saveload_storage_customization')
							? (e.metaInfo.uid.deleteValue(),
							  ...
							  this._doSave())
							: window.open(
									'/chart/?clone=' + e.metaInfo.uid.value() + '&name=' + encodeURIComponent(t),
									'_blank',
							  );
					}),
