...
import SpotAndFiatItem from './index';

// ================================================:
describe('Spot and fiat item component:', () => {
	it('Spot and fiat item component must be render', () => {
		const testWalletItemData = {
			id: 6,
			asset: {
				id: 2,
				code: 'btc',
		...
		const { container } = render(
			<ReduxProvider store={store}>
				<BrowserRouter>
					<SpotAndFiatItem data={testWalletItemData} balancesIsHide />
				</BrowserRouter>
			</ReduxProvider>,
		);
