...
import ConvertDropdown from './index';

// ================================================:
describe('Convert dropdown component:', () => {
	it('Convert dropdown component must be render', () => {
		...
		const { container } = render(
			<ReduxProvider store={store}>
				<BrowserRouter>
					<ConvertDropdown value={null} onChange={testOnChange} options={testOptionsData} />
				</BrowserRouter>
			</ReduxProvider>,
		);
